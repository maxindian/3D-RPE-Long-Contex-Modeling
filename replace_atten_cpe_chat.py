...
class CPERotaryEmbedding(nn.Module):
    def __init__(self, dim, max_position_embeddings=8192, base=500000.0, scaling_factor=1.0, device=None):
        super().__init__() 
    ...
    def _set_cos_sin_cache(self, seq_len, device, dtype):
        ...
        inv_freq_bs = 1.0 / (10000.0 ** (torch.arange(0, self.space_rotary_dim).float().to(device)))
...
def replace_with_cpellama(pretraining_length=8196, local_window_size=None):
    global chunk_size
    global local_window
